...
import { createVarsResolver, rem, getThemeColor, factory, useProps, useMantineTheme, useStyles, useResolvedStylesApi, Box } from '@mantine/core';
...
const getLabel = (labelsType, valueFormatter) => ({ x, y, cx, cy, percent, value }) => /* @__PURE__ */ jsx(
  "text",
  {
    x,
    y,
