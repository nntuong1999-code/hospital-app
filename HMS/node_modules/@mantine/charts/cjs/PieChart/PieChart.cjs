...
const getOutsideLabel = (labelsType, valueFormatter) => ({ x, y, cx, cy, percent, value }) => /* @__PURE__ */ jsxRuntime.jsx(
  "text",
  {
    x,
    y,
    ...
    fontSize: 12,
    children: /* @__PURE__ */ jsxRuntime.jsx("tspan", { x, children: getLabelValue(labelsType, value, percent, valueFormatter) })
  }
);
